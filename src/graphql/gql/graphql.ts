...
export type GetTimezonesQuery = { __typename?: 'Query', timezones: { __typename?: 'TimezonePage', totalCount: number, hasNextPage: boolean, items: Array<{ __typename?: 'Timezone', id: string, name: string, region: string }> } };
