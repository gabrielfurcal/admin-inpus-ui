    ...
    return (
        <div className='relative mb-5' data-twe-input-wrapper-init>
            <select
                ...
                className='peer block min-h-[auto] w-full rounded shadow-sm bg-gray-50 px-3 py-[0.32rem] leading-[1.6] outline-none transition-all duration-200 ease-linear peer-focus:text-primary motion-reduce:transition-none dark:text-white dark:autofill:shadow-autofill dark:peer-focus:text-primary'
